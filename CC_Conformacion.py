...
def CC_Conformacion(usuario,puesto):
  ...
  fecha_11= placeholder8_11.date_input("Fecha",key="fecha_11")

  placeholder9_11= st.empty()
  bloque_11= placeholder9_11.number_input("Bloque",max_value=1000000000,step=1,key="bloque_11")
  ...
  # ----- Capacitación ---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,proceso,usuario,nombre,horario,fecha,bloque,estado,predios,horas,puesto,tipo,supervisor)VALUES('{marca_11}','Control de Calidad Conformación','{usuario}','{nombre_11}','{horario_11}','{fecha_11}','{bloque_11}','{estado_11}','{predios_11}','{horas_11}','{puesto}','No Aplica','{supervisor_11}')")
    con.commit()
