...
def IFIII(usuario,puesto):
  ...
  bloque_5= placeholder9_5.number_input("Bloque",min_value=0,max_value=1000000000,step=1,key="bloque_5")
  ...
  # ----- Capacitación ---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,proceso,usuario,nombre,horario,fecha,bloque,estado,predios,horas,puesto,tipo,supervisor)VALUES('{marca_5}','Información Final III','{usuario}','{nombre_5}','{horario_5}','{fecha_5}','{bloque_5}','{estado_5}','{predios_5}','{horas_5}','{puesto}','{tipo_5}','{supervisor_5}')")
    con.commit()
