...
st.set_page_config(page_title="Formularios TPZ",page_icon=img)
...
hide_menu_style = """
        ...
        footer:after{
            content:'Copyrigth @ 2023 Telespazio Argentina S.A';
            display: block;
            position: relative;
            color: tomato;
        }
...
if pivot!=1:
     ...
     st.subheader("En caso de dudas favor revisar el siguiente video tutorial https://www.youtube.com/watch?v=dyj8bqCF4XE")

     st.subheader("Para soporte téncico favor escribir a basilio.nunez@tpzco.com")