...
def IFI(usuario,puesto):
  ...
  fecha_3= placeholder8_3.date_input("Fecha",key="fecha_3")

  placeholder9_3= st.empty()
  bloque_3= placeholder9_3.number_input("Bloque",min_value=0,max_value=1000000000,step=1,key="bloque_3")
  ...
  # ----- Capacitación ---- #
    ...
    cursor01.execute(f"INSERT INTO registro (marca,proceso,usuario,nombre,horario,fecha,bloque,estado,predios,horas,puesto,tipo,supervisor)VALUES('{marca_3}','Información Final I','{usuario}','{nombre_3}','{horario_3}','{fecha_3}','{bloque_3}','{estado_3}','{predios_3}','{horas_3}','{puesto}','{tipo_3}','{supervisor_3}',")
    con.commit()
